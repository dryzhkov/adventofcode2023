import { solvePuzzle, solvePuzzlePart2 } from './trebuchet';
...
const realData = `twovgtprdzcjjzkq3ffsbcblnpq
...
describe('part 1', () => {
    it('sample', () => {
        const answer = solvePuzzle(testData1);
        console.log(answer);
...
describe('part 2', () => {
    it('sample', () => {
        const answer = solvePuzzlePart2(testData2);
        console.log(answer);
        expect(answer).toBe(281);
    });

    it('real test', () => {
        const answer2 = solvePuzzlePart2(realData);
        console.log(answer2);
        expect(answer2).toBe(55427);
    });
});
